...
# Hướng dẫn GroupDocs API và Đoạn mã

Chào mừng đến với trung tâm hướng dẫn chính thức cho các API thao tác tài liệu GroupDocs. Tài nguyên toàn diện này cung cấp các hướng dẫn chi tiết, ví dụ mã và các thực hành tốt nhất để triển khai sản phẩm GroupDocs trong ứng dụng .NET và Java của bạn.

{{% alert color="primary" %}}
**TÀI NGUYÊN NHẬP PHÁT TRIỂN:** Mỗi phần sản phẩm bên dưới chứa các liên kết đến hướng dẫn .NET và Java, với các ví dụ mã thực tế và hướng dẫn triển khai từng bước.
{{% /alert %}}
...
#### [GroupDocs.Assembly](#)
{{% alert color="primary" %}}
**Tạo tài liệu từ mẫu và dữ liệu**  
Tạo báo cáo động, hóa đơn và tài liệu cá nhân hóa bằng cách điền mẫu với dữ liệu từ các nguồn khác nhau bao gồm cơ sở dữ liệu và JSON.
{{% /alert %}}

* [Hướng dẫn GroupDocs.Assembly for .NET](#)
* [Hướng dẫn GroupDocs.Assembly for Java](#)
...
{{% alert color="primary" %}}
**Tự động phân loại tài liệu và văn bản**  
Triển khai phân loại tài liệu dựa trên machine learning với hỗ trợ phân loại IAB-2, phân loại tài liệu và phân tích cảm xúc cho tổ chức nội dung.
{{% /alert %}}

* [Hướng dẫn GroupDocs.Classification for .NET](#)
* [Hướng dẫn GroupDocs.Classification for Java](#)
...
Hướng dẫn toàn diện và tham chiếu API cho tất cả sản phẩm GroupDocs.

[Tài liệu API →](https://reference.groupdocs.com/)

### Ví dụ Mã

Dự án mẫu và triển khai để giúp bạn bắt đầu nhanh chóng.

[Xem trên GitHub →](https://github.com/groupdocs)

### Dùng thử Miễn phí

Tải xuống và dùng thử sản phẩm của chúng tôi không giới hạn trước khi mua.

[Tải xuống Ngay →](https://downloads.groupdocs.com/)

### Cộng đồng Nhà phát triển

Nhận trợ giúp và hỗ trợ từ các nhà phát triển và người dùng khác của chúng tôi.

[Tham gia Diễn đàn →](https://forum.groupdocs.com/)