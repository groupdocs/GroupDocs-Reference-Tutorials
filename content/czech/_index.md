...
# GroupDocs API Výukové programy a úryvky kódu

Vítejte v oficiálním centru výukových programů pro GroupDocs API pro manipulaci s dokumenty. Tento komplexní zdroj poskytuje podrobné výukové programy, příklady kódu a osvědčené postupy pro implementaci GroupDocs produktů ve vašich .NET a Java aplikacích.

{{% alert color="primary" %}}
**ZDROJE PRO VÝVOJÁŘE:** Každá sekce produktu níže obsahuje odkazy na .NET a Java výukové programy s praktickými příklady kódu a postupnými průvodci implementací.
{{% /alert %}}
...
## Řešení pro zabezpečení dokumentů
...
## Řešení pro zpracování dokumentů
...
#### [GroupDocs.Assembly](#)
{{% alert color="primary" %}}
**Vytváření dokumentů ze šablon a dat**  
Generování dynamických zpráv, faktur a personalizovaných dokumentů vyplňováním šablon s daty z různých zdrojů včetně databází a JSON.
{{% /alert %}}

* [GroupDocs.Assembly for .NET Výukové programy](#)
* [GroupDocs.Assembly for Java Výukové programy](#)
...
{{% alert color="primary" %}}
**Automatické kategorizování dokumentů a textu**  
Implementace klasifikace dokumentů založené na strojovém učení s podporou IAB-2 taxonomie, kategorizace dokumentů a analýzy sentimentu pro organizaci obsahu.
{{% /alert %}}

* [GroupDocs.Classification for .NET Výukové programy](#)
* [GroupDocs.Classification for Java Výukové programy](#)
...
Komplexní průvodci a API reference pro všechny GroupDocs produkty.

[API Dokumentace →](https://reference.groupdocs.com/)

### Ukázky kódu

Ukázkové projekty a implementace, které vám pomohou rychle začít.

[Zobrazit na GitHub →](https://github.com/groupdocs)

### Bezplatné zkušební verze

Stáhněte a vyzkoušejte naše produkty bez omezení před nákupem.

[Stáhnout nyní →](https://downloads.groupdocs.com/)

### Komunita vývojářů

Získejte pomoc a podporu od našich vývojářů a ostatních uživatelů.

[Připojit se k fóru →](https://forum.groupdocs.com/)